...
public class PlayerCharacterController : MonoBehaviour, ICharacterController
{
    ...
    private void GetInputs()
    {
        ...
        else if(inputBank.LastButtonInput == ButtonInput.JumpReleased)
        {
            jumpReleased = true;
        }
        */
    ...
    {
        if (inputBank.RawMoveInput.magnitude != 0f)
        ...
        currentRotation = Quaternion.LookRotation(smoothedForwardDirection, Motor.CharacterUp);
    }
